...
QT_MOC_LITERAL(1, 10, 15), // "recevie_success"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 3), // "img"
QT_MOC_LITERAL(4, 31, 22), // "processPendingDatagram"
QT_MOC_LITERAL(5, 54, 11) // "close_slots"

    },
    "UdpThread\0recevie_success\0\0img\0"
    "processPendingDatagram\0close_slots"
};
...
void UdpThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->recevie_success((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        case 1: _t->processPendingDatagram(); break;
        case 2: _t->close_slots(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (UdpThread::*)(QImage );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UdpThread::recevie_success)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void UdpThread::recevie_success(QImage _t1)
{
